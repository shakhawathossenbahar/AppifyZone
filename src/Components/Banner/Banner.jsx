...
const Banner = () => {
  return (
    <div className="flex flex-col items-center px-4 md:px-8 lg:px-12">
      <h1 className="text-center text-black text-4xl md:text-7xl font-bold">
        We Build <br />
      ...
      <p className="my-10 text-gray-500 text-center">
        At AppifyZone , we craft innovative apps designed to make everyday life
      ...
      <div className="flex flex-col md:flex-row gap-4 text-center items-center ">
        <Link to={"https://play.google.com/store/games?hl=en"}>
          <button className="flex px-5 py-2 border-1 border-gray-300 cursor-pointer rounded-md font-semibold gap-1">
            <img src={playstorLogo} alt="PlayStore" />
            Google Play
          </button>
        </Link>
      ...
      <div className="w-full bg-gradient-to-r from-[#632EE3] to-[#9F62F2] text-white py-20 flex flex-col justify-center items-center px-4 md:px-8 lg:px-12">
        <h1 className="font-bold text-3xl text-center md:text-5xl mb-7">
